...
Both public and private registries are supported, for both scoped and unscoped modules, as long as the registry uses either bearer tokens or basic authentication.
